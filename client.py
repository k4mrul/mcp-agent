...
def create_message_template():
    ...
    template = (
        ...
        "- Check service/pod status (is X running?, what's the status of X?)\n\n"
        ...
        "- 'is browser service running?' -> 'check status of browser service by listing pods'\n"
        "- 'what's the status of api service?' -> 'check status of api service by listing pods'\n"
        "- 'is payment pod running?' -> 'check status of payment pods by listing pods'\n\n"
